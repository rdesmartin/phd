...
\begin{itemize}
\item Imandra's language is sufficiently flexible to give rise to several versions of the NN library depending on the choice of the matrix implementation, and its automated proof heuristics
...
%this provides a strong foundation to further develop the Imandra CNN library.
