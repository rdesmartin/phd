...
Note that since the output of the function \lstinline{map2} is wrapped in the monadic result type \lstinline{result}, we must use \lstinline{Result.map} to apply \lstinline|sum|. 
...
\rnote{I'm not sure what is meant in this last sentence.}
...
\section{Matrices as Functions} \label{section:functions}
